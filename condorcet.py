...
class Condorcet(BaseCog):
    ...
    @commands.command(name='condorcet_pass')
    ...
    @commands.command(name='condorcet_apply')
    ...
    @commands.command(name='condorcet_leave')
    ...
    @commands.command(name='condorcet_vote')
    ...
    @commands.command(name='condorcet_info')
    ...
    @commands.command(name='condorcet_new')
    ...
    @commands.command(name='condorcet_open')
    @commands.has_role(DISCORD_ADMIN)
    ...
    @commands.command(name='condorcet_close')
    @commands.has_role(DISCORD_ADMIN)
